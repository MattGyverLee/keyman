...
/*
  ...
  A physical Left Shift release reaches the hook as VK_LSHIFT; Keyman's injected one reaches it as
  VK_SHIFT with scan SCAN_FLAG_KEYMAN_KEY_EVENT, because do_keybd_event collapses the chiral VK.
  Both land on kbd[VK_LSHIFT], so these cases do not depend on which form Windows reports for
  injected input.
*/
